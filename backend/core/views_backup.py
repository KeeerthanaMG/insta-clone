...
class MessageListView(APIView):
    ...
    def get(self, request, thread_id):
        ...
        if not is_participant:
            ...
            # Use the centralized bug detection system
            bug_result = trigger_bug_found(
                user=request.user,
                bug_title="IDOR on Direct Messages",
                points=100
            )
            ...
            if bug_result['success']:
                ...
                response_data = {
                    ...
                    "bug_name": "IDOR on Direct Messages",
                    "points_awarded": bug_result['points_awarded'],
                    "total_points": bug_result['total_points'],
                    "message": bug_result['message'],
                    "ctf_message": bug_result['message'],
                    "vulnerability_detected": True,
                    "description": "🎉 Congratulations! You found the IDOR bug in Direct Messages and earned points!"
                }
...
# Add this new view after the trigger_bug_found function
